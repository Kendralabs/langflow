...
export const DESCRIPTIONS: string[] = [
  ...
  "Kendra: Create, Chain, Communicate.",
...
export const API_PAGE_PARAGRAPH =
  "Your secret Kendra API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const LANGFLOW_CHAT_TITLE = "Kendra Chat";
...
export const STORE_TITLE = "Kendra Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your Kendra API key.";
